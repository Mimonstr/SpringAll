...
//    }
    ...
    //Этот эдвайс может работать с возвращаемым значением метода
    //И в методе мейн будет уже обновленное значение
...
//    {
//        //Можем что-то сделать до того, как исключение, попадет в метод мейн(оно туда сто процентов попадет)
//        System.out.println("afterThrowingGetStudentsLoggingAdvice: логируем выброс исключения " + exception);
//    }



    //Нельзя получить доступ ни к исключению, ни к возвращаемому значению!!!
